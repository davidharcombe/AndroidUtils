...
public class CollectionPartition {
	 ...
	 * example, * partitioning a list containing {@code [a, b, c, d, e]} with a
	 ...
	 * list the list to return consecutive sublists of * @param size the desired
	 * size of each sublist (the last may be * smaller) * @return a list of
	 * consecutive sublists * @throws IllegalArgumentException if
	 * {@code partitionSize} is nonpositive *
	 */
